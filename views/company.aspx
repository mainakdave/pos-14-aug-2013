<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company.aspx.cs" Inherits="POS.views.company" MasterPageFile="~/views/masterPage.Master" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#menu .nav li#company").addClass("active");
        ...
        function updateRow(id, name, address1, address2, city, state, country, zipcode, region, officePhone, officeFax, taxtID, vatID, salesEmail, supportEmail, contactUsEmail) 
        {
            ...
            if (!window.isDelete) {
                ...
                src = "../uploadedImg/company/" + id + ".jpg";
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div id="breadCrum"><h1>Master > Company</h1></div>
    ...
    <div id="content">   
        ...
        <div class="tabbable contentbox" id="tabContent"> 
                ...
                <div class="tab-pane active" id="tab1">
                    ...
                    <div id="searchArea">
                        <asp:DropDownList id="searchBy" runat="server" AutoPostBack="false">
                            ...
                            <asp:ListItem Value="companyID" Text="Company ID"></asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <!-- <asp:Panel ID="Panel1" ScrollBars="Vertical" Height="300" runat="server"> -->
                        <asp:ListView ID="lstvCompany" runat="server">
            <LayoutTemplate >
            ...
            <ItemTemplate>
                ...
                <asp:PlaceHolder id="itemPlaceholder" runat="server" />
                <tr ondblclick="updateRow(<%#Eval("companyID") %>, '<%#Eval("name") %>', '<%#Eval("address1") %>', '<%#Eval("address2") %>', '<%#Eval("city") %>', '<%#Eval("state") %>', '<%#Eval("country") %>', '<%#Eval("zipcode") %>', '<%#Eval("region") %>', '<%#Eval("officePhone") %>', '<%#Eval("officeFax") %>', '<%#Eval("taxtID") %>', '<%#Eval("vatID") %>', '<%#Eval("salesEmail") %>', '<%#Eval("supportEmail") %>', '<%#Eval("contactUsEmail") %>') ;
                ...
                ">
                    <td>
                        <asp:Label ID="lbCompanyID" runat="Server" Text='<%#Eval("companyID") %>' />
                    </td>

                    <td>
                        <asp:Label ID="lbCompanyName" runat="Server" Text='<%#Eval("name") %>' />
                    </td>

                    <td class="btn btn-danger btn-mini"  onmouseup="deleteRow(<%#Eval("companyID") %>)" style="cursor:pointer"></td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
                    ...
                    <div class="pagination">
                        <asp:DataPager ID="DataPager" runat="server" PagedControlID="lstvCompany" 
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <form class="navbar-form pull-left" id="companyForm" action="company.aspx">

                     

                   <div id="company" class="row-fluid">
                    <div class="span6">
                        <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="name" type="text" placeholder="Company Name" class="span2"  />
